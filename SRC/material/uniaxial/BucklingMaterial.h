...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/BucklingMaterial.h,v $

// Written: MHS
// Created: July 2000
//
// Description: This file contains the class definition for 
// BucklingMaterial.  BucklingMaterial provides the implementation
...
#ifdef _CSS
#ifndef BucklingMaterial_h
#define BucklingMaterial_h

#include <UniaxialMaterial.h>


class BucklingMaterial : public UniaxialMaterial
{
 public:
  BucklingMaterial(int tag,
		     ...
		     double damfc1p, double damfc2p,
		     double damfc1n, double damfc2n,
		     double beta = 0.0);
  BucklingMaterial(int tag,
		     double mom1p, double rot1p, double mom2p, double rot2p,
		     double mom1n, double rot1n, double mom2n, double rot2n,
  ...
  const char *getClassType(void) const {return "BucklingMaterial";};
 ...
 private:
  ...
  // Damage parameters
  double damfc1p;		// Deformation
  double damfc2p;		// Energy
  double damfc1n;		// Deformation
  double damfc2n;		// Energy
  double Tdamfcn;		// Energy
  double Cdamfcn;		// Energy

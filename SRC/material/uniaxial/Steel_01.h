...
// $Source: /usr/local/cvs/OpenSees/SRC/material/uniaxial/Steel_01.h,v $
...
class Steel_01 : public UniaxialMaterial
{
  public:
    Steel_01(int tag, double fy, double E0, double b,
       double a1 = STEEL_01_DEFAULT_A1, double a2 = STEEL_01_DEFAULT_A2,
       double a3 = STEEL_01_DEFAULT_A3, double a4 = STEEL_01_DEFAULT_A4);
    Steel_01();
    ~Steel_01();

    const char *getClassType(void) const {return "Steel_01";};
